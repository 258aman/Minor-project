...
st.markdown('''<p style="font-weight:bold; font-size: 22px; font-family:Gerogia">Spotify transformed music listening forever when it launched in Sweden in 2008. Discover, 
...
st.markdown('<h2 style="color: maroon; text-align:center; background-color: #AEF359; font-family:Verdana; border: 3px solid black; border-radius:5px; margin-bottom: 20px; ">DATA VISUAIZATION ON HISTOGRAM</h2>', unsafe_allow_html=True)
...
st.markdown('<h2 style="color: maroon; text-align:center; background-color: #AEF359; font-family:Verdana; border: 3px solid black; border-radius:5px; margin-bottom: 20px; ">DATA VISUAIZATION ON AREA GRAPH</h2>', unsafe_allow_html=True)
...
st.markdown('<h2 style="color: maroon; text-align:center; background-color: #AEF359; font-family:Verdana; border: 3px solid black; border-radius:5px; margin-bottom: 20px; ">DATA VISUAIZATION ON BAR GRAPH</h2>', unsafe_allow_html=True)
...
st.markdown('<h2 style="color: maroon; text-align:center; background-color: #AEF359; font-family:Verdana; border: 3px solid black; border-radius:5px; margin-bottom: 20px; ">DATA VISUAIZATION ON BAR</h2>', unsafe_allow_html=True)
...
st.markdown('<h2 style="color: maroon; text-align:center; background-color: #AEF359; font-family:Verdana; border: 3px solid black; border-radius:5px; margin-bottom: 20px; ">DATA VISUAIZATION ON LINE GRAPH</h2>', unsafe_allow_html=True)
...
st.markdown('<h2 style="color: maroon; text-align:center; background-color: #AEF359; font-family:Verdana; border: 3px solid black; border-radius:5px; margin-bottom: 20px; ">DATA VISUAIZATION ON TREEMAP</h2>', unsafe_allow_html=True)
...
st.markdown('<h2 style="color: maroon; text-align:center; background-color: #AEF359; font-family:Verdana; border: 3px solid black; border-radius:5px; margin-bottom: 20px; ">DATA VISUAIZATION ON PIE GRAPH</h2>', unsafe_allow_html=True)
...
st.markdown('<h2 style="color: maroon; text-align:center; background-color: #AEF359; font-family:Verdana; border: 3px solid black; border-radius:5px; margin-bottom: 20px; ">DATA VISUAIZATION ON BOX GRAPH</h2>', unsafe_allow_html=True)
...
st.markdown('<h2 style="color: maroon; text-align:center; background-color: #AEF359; font-family:Verdana; border: 3px solid black; border-radius:5px; margin-bottom: 20px; ">DATA VISUAIZATION ON SCATTER GRAPH</h2>', unsafe_allow_html=True)
